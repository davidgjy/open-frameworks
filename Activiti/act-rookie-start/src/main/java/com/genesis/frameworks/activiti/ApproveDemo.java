 ...
 * @author: KG
 * @description:
 * @date: Created in 下午3:31 2018/9/27
 * @modified by:
 */

public class ApproveDemo {
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(ApproveDemo.class);
    ...
    private static ProcessDefinition getProcessDefinition(ProcessEngine processEngine) {
        ...
        deploymentBuilder.addClasspathResource("second_approve.bpmn20.bpmn");
